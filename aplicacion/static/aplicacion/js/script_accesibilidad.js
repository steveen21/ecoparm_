document.addEventListener("DOMContentLoaded", function() {
    const defaultOptions = {
        ...
        buttonIconColor: '#ffffff', // Ícono blanco para buen contraste
        highlightColor: '#52b788', // Verde vibrante para resaltar
        menuBackgroundColor: '#e9f5e9', // Verde pastel suave para el fondo
    ...
    <style>
        ...
        .asw-btn { width: 140px; height: 120px; border-radius: 8px; padding: 15px; display: flex; align-items: center; justify-content: center; flex-direction: column; text-align: center; color: #333; background:rgb(255, 255, 255); border: 3px solid #2c8824; transition: background-color .3s; cursor: pointer; }
        ...
        .asw-adjust-font { background:rgb(255, 255, 255); border: 3px solid #2c8824; padding: 20px 25px; margin-bottom: 16px; }
